...
const initialRows = [
  createData(1, 'Exame', 'Coleta de DNA', '2022-01-01', '2022-01-02', 'Concluída', 'Nenhum'),
  createData(2, 'Exame', 'Coleta de Urina', '2022-01-03', '2022-01-04', 'Em Andamento', 'Nenhum'),
  createData(3, 'Exame', 'Coleta de Sangue', '2022-01-04', '2022-01-05', 'Em Andamento', 'Próximo Procedimento'),
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 850 }} size="small" aria-label="a dense table">
                ...
                <TableRow>
                    ...
                    <TableCell align="right">Tipo de Consulta</TableCell>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      <TableCell component="th" scope="row" border>
                          {row.idTarefa}
                      </TableCell>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen}>Criar Consulta</Button>
